...
public class Log {
    ...
    public static void setSalida (){
        ...
        try {
            ...
            String primerLog = "<html><head><title>Sistema Para Gestion de Pedidos Tu Lunch - Log "+ usuario +"</title><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><meta name=\"generator\" content=\"NetBeans IDE 6.0\" /><meta name=\"author\" content=\"DeveloperDreamTeam\" />" +
                               "<style>*{margin:0px;padding:0px;font-size:13px;}td{line-height:11pt;}#contenido{margin:30px auto 10px auto;width:760px;color:#000;background-color:#FFF;}#titulo{font-size:20px;margin-bottom:5px;text-align:center;}#subTitulo{font-size:15px;text-align:center;}#cabezera{width:500px;margin:0px auto;}#infoInicial{width:500px;}.tipoDatoInicial{background-color:#FFA023;color:#FFF;font-weight:bold;width:160px;padding-left:5px;border-right:1px solid #B47420;border-left:1px solid #B47420;border-bottom:1px solid #B47420;}.datoInicial{padding-left:5px;border-right:1px solid #B47420;border-bottom:1px solid #B47420;}#contenidoLogs{width:830px;margin:0px auto;text-align:center;color:#000;background-color:#FFF;}#cabezeraLogs{color:#FFF;font-weight:bold;background-color:#FFA023;text-align:center}.tipoEvento{text-align:center;width:120px;border-right:1px solid #B47420;border-bottom:1px solid #B47420;}.detalleEvento{width:460px;border-right:1px solid #B47420;border-bottom:1px solid #B47420;padding-left:5px;}.fechaEvento{text-align:center;width:250px;border-right:1px solid #B47420;border-bottom:1px solid #B47420;border-left:1px solid #B47420;}.superior{border-top:1px solid #B47420;}.salto{text-align:left;margin:0px auto;padding-left:70px;}</style>"+
                               "</head><body><div id=\"contenido\"><h1 id=\"titulo\">Sistema Para Gestion de Pedidos Tu Lunch</h1><h2 id=\"subTitulo\">LOG DEL"+ usuario +"</h2><br /><div id=\"cabezera\"><table id=\"infoInicial\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr><div class=\"superior\"><td class=\"tipoDatoInicial\">IP del "+ usuario +" :</td><td class=\"datoInicial\">"+ ip +
                               ...
                               "</td></tr></table></div><br /></div><div id=\"contenidoLogs\"><table id=\"cabezeraLogs\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr><div class=\"superior\"><td class=\"fechaEvento\">Fecha y Hora de Evento</td><td class=\"tipoEvento\">Tipo de Evento</td><td class=\"detalleEvento\">Detalle del Evento</td></div></tr></table></div>";
            escribir(primerLog);
        }
    }
    ...
    public static void setEvento(String usuarioEvento,String tipoEvento, String evento) {
        ...
        if(!infoInicial){
            infoInicial = true;
            setSalida();
            log = "<div id=\"contenidoLogs\"><table border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr><td class=\"fechaEvento\">"+ tiempoEvento() +"</td><td class=\"tipoEvento\">"+ tipoEvento +"</td><td class=\"detalleEvento\">"+ evento +"</td></tr></table></div>";
            escribir(log );
        }
        else{
            crearEscritor();
