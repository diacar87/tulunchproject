    ...
    private void initComponents() {
        ...
        panelEstadoLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelEstadoLayout.createSequentialGroup()
                .addComponent(barraEstado, javax.swing.GroupLayout.DEFAULT_SIZE, 474, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(botonCambiarPassword)
                .addGap(18, 18, 18)
                .addComponent(botonCerrarSesion)
                .addGap(18, 18, 18)
                .addComponent(botonCerrarAplicacion))
        );

        panelEstadoLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {botonCambiarPassword, botonCerrarAplicacion, botonCerrarSesion});
